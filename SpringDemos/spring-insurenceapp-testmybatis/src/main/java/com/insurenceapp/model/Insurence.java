...
public class Insurence {
	...
	public Insurence(Integer insurenceId, String policyName, String brand, String type, int duration, double premium) {
		super();
	...
	public String toString() {
		return "Insurence [insurenceId=" + insurenceId + ", policyName=" + policyName + ", brand=" + brand + ", type="
